...
contract('Governance Requiem Locks', function (accounts) {
  ...
  beforeEach(async function () {
    ...
    this.token = await factoryVote.deploy(name, symbol, this.lockedToken.address, this.curveProvider.address, '1');
  ...
  it('allows creation of lock', async function () {
    const amount = '1000000000000000000000' //10k
  ...
  it('allows increase of locked amount', async function () {
    const amount = '1000000000000000000000' //10k
  ...
  it('allows increase of locked time full lock', async function () {
    const amount = '1000000000000000000000' //10k
  ...
  it('allows increase of locked time for half a lock', async function () {
    const amount = '1000000000000000000000' //10k
    ...
    const amountToIncreaseMaturity = '500000000000000000000' //10k
